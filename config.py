...
class Config:
    ...
    OPENAI_FAILURE_THRESHOLD = int(
        os.getenv("OPENAI_FAILURE_THRESHOLD", "2")
    )
    OPENAI_RETRY_COOLDOWN_SECONDS = float(
        os.getenv("OPENAI_RETRY_COOLDOWN_SECONDS", "30")
    )
    OPENAI_RATE_LIMIT_COOLDOWN_SECONDS = float(
        os.getenv("OPENAI_RATE_LIMIT_COOLDOWN_SECONDS", "120")
    )
    OPENAI_MAX_COOLDOWN_SECONDS = float(
        os.getenv("OPENAI_MAX_COOLDOWN_SECONDS", "300")
    )
